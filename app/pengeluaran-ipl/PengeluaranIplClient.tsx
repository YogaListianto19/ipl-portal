...
export function PengeluaranIplClient({ expenses }: Props) {
  ...
  return (
    <main className="max-w-xl mx-auto lg:max-w-3xl px-4 py-5 pb-24 lg:pb-8 space-y-5">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-rose-900 via-rose-700 to-pink-600 p-5 shadow-md shadow-primary/20">
        ...
        <h1 className="text-xl font-bold text-white relative">Pengeluaran IPL</h1>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Card className="col-span-2 border-border/50 shadow-sm bg-linear-to-br from-primary/5 to-background">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              <p className="text-xs text-muted-foreground font-medium">Total Pengeluaran IPL</p>
        ...
        <Card className={cn('border-border/50 shadow-sm', summary.pendingAmount > 0 && 'border-amber-200/70 bg-amber-50/50')}>
          <CardContent className="p-4">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">{expenses.length - summary.paidCount} tagihan</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="space-y-2">
        {filtered.length === 0 ? (
          <div className="text-center py-10 text-muted-foreground">
            ...
            <p className="text-sm">Tidak ada data pengeluaran IPL</p>
          </div>
        ) : (
